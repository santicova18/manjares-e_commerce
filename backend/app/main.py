...
from app.api.routes import productos, categoria, admin, configuracion_tienda, pedido
...
api_v1_router.include_router(configuracion_tienda.router, prefix="/configuracion", tags=["Configuración"])
api_v1_router.include_router(pedido.router, prefix="/pedidos", tags=["Pedidos"])
